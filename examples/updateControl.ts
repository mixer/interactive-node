...
import { GameClient, IButton, IParticipant, setWebSocket } from '../lib';
            ...
            controls.forEach((control: IButton) => {
                ...
                control.on('mousedown', (inputEvent, participant) => {
                    ...
                    if (inputEvent.transactionID) {
                        ...
                        client
                            .captureTransaction(inputEvent.transactionID)
                            .then(() => {
                                console.log(
                                    `Charged ${participant.username} ${
                                        control.cost
                                    } sparks!`,
                                );
                            });
